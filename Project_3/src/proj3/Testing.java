 ...
 * here are static so there's no need to construct a proj3.Testing object.  Just call them
 * with the class name like so:
 * <p></p>
 * <code>proj3.Testing.assertEquals("test description", expected, actual)</code>
 * 
